...
_SYSTEM = (
    "Ты — комплаенс-аналитик. Тебе дают сырые данные World-Check о санкционных "
    "записях (на английском). Перепиши КАЖДУЮ запись в 1–2 коротких предложениях "
    "на простом русском языке: за что и кем наложены санкции. "
        ...
        payload.append(
            {
                ...
                "details": raw or "нет подробностей",
            }
        )
